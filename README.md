...
| 首页 · 一句话开始 | 实时执行链 · 高德地图联动 |
|:---:|:---:|
| ![首页](docs/screenshots/home.png) | ![实时执行链](docs/screenshots/planning.png) |

| 规划完成 · 杂志风阅读态 | 行程详情 · 预算与每日安排 |
|:---:|:---:|
| ![规划完成](docs/screenshots/done.png) | ![行程详情](docs/screenshots/detail.png) |
